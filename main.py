...
# setup
bot_token = os.environ.get("TOKEN", "8179604363:AAF4s6Wnkjpe-krceyMoJFtyLgSIMNGVvFw") 
api_hash = os.environ.get("HASH", "ef85493cd32eadcb5309b5957d8d1b86") 
api_id = os.environ.get("ID", "22606849") 
